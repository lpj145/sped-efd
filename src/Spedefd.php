...
class Spedefd
{
    ...
    private function abreEEncerraBlocoB()
    {
        $this->text .= $this->textTag('B001', '1');
        $this->text .= $this->textTag('B990', '2');
    }
    ...
    private function abreencerrabloco01()
    {
        ...
        $this->text .= $this->textTag('1010', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N');
